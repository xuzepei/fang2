...
//	}
	...
	private static String iPhoneId = "77a80bd19907dee1d52e2712ebe268349cee1a62296dddaa0d189fd086fe5dac";
	
	//正式版使用
//	private static final String HOST = "gateway.push.apple.com";
//	private static String certificate = "./apns-pro-cert.p12";
//	private static String iPhoneId = "d572dcf07da814651e5cd537eb4e0a1e8e840f324b87b356756545be0b9402ef";
	...
	public static void main(String[] args) throws Exception {
			...
			try { 
				...
				pushManager.addDevice("iPhone", iPhoneId); //这里可以add多个Device,发送后需要removeDevice
