...
- (void)updateContent:(NSDictionary*)item
{
    ...
    NSString* urlString = [NSString stringWithFormat:@"%@/2hand_content.php?apiid=%@&pwd=%@&id=%@&username=%@&ios=1",BASE_URL,APIID,PWD,id,[RCTool getUsername]];
...
- (void)clickedFavoriteButton:(id)sender
{
    ...
    {
        urlString = [NSString stringWithFormat:@"%@/favorite.php?apiid=%@&pwd=%@&action=del&class=2&hid=%@&username=%@",BASE_URL,APIID,PWD,hid,[RCTool getUsername]];
    }
    else
    {
        urlString = [NSString stringWithFormat:@"%@/favorite.php?apiid=%@&pwd=%@&action=add&class=2&hid=%@&username=%@",BASE_URL,APIID,PWD,hid,[RCTool getUsername]];
    }
