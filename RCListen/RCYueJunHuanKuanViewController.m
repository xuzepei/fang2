//
//  RCYueJunHuanKuanViewController.m
//  RCFang
//
...
@interface RCYueJunHuanKuanViewController ()

@end

@implementation RCYueJunHuanKuanViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	if(item)
	{
        NSString* temp = [NSString stringWithFormat:@"%d月: %@元",indexPath.row+1,item];
