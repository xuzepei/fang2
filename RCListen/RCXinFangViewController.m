//
//  RCXinFangViewController.m
//  RCFang
//
//  Created by xuzepei on 3/17/13.
...
#import "RCThisMonthViewController.h"
...
@interface RCXinFangViewController ()

@end

@implementation RCXinFangViewController
...
- (void)initAdScrollView
{
    ...
    NSDictionary* ad = [RCTool getAdByType:@"newhouse"];
    if(ad)
    {
...
- (void)finishedAdRequest:(NSString*)jsonString
{
    ...
    if(result && [result isKindOfClass:[NSDictionary class]])
    {
        [RCTool setAd:@"newhouse" ad:result];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    else
    {
        ...
        if(0 == indexPath.row)
        {
            cell.textLabel.text = TITLE_0;
            cell.imageView.image = [UIImage imageNamed:@"fangchandaogou"];
        }
        else if(1 == indexPath.row)
        {
            cell.textLabel.text = TITLE_1;
            cell.imageView.image = [UIImage imageNamed:@"tuangou"];
        }
        else if(2 == indexPath.row)
        {
            cell.textLabel.text = TITLE_2;
            cell.imageView.image = [UIImage imageNamed:@"benyuekaipan"];
        }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if(0 == indexPath.section)
    {
        ...
        if(0 == indexPath.row)
        {
            type = 1;
            title = TITLE_0;
            RCZiXunViewController* temp = [[RCZiXunViewController alloc] initWithNibName:nil bundle:nil];
            temp.title = title;
            [temp updateContent:type];
...
//            title = TITLE_2;
            ...
            RCThisMonthViewController* temp = [[RCThisMonthViewController alloc] initWithNibName:nil bundle:nil];
            temp.hidesBottomBarWhenPushed = YES;
            [self.navigationController pushViewController:temp animated:YES];
