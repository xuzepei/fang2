...
//        [nickname drawInRect:CGRectMake(10, 12, 200, 20) withFont:[UIFont boldSystemFontOfSize:14] lineBreakMode:NSLineBreakByCharWrapping alignment:NSTextAlignmentLeft];
        ...
        if(self.item)
        {
            NSString* jifen = [NSString stringWithFormat:@"积分：%@",[self.item objectForKey:@"credit"]];
            [jifen drawInRect:CGRectMake(10, 46, 200, 20) withFont:[UIFont boldSystemFontOfSize:14] lineBreakMode:NSLineBreakByCharWrapping alignment:NSTextAlignmentLeft];
        }
    }
    else
    {
