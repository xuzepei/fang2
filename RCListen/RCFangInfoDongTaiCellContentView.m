//
//  RCFangInfoDongTaiCellContentView.m
//  RCFang
//
...
@implementation RCFangInfoDongTaiCellContentView
...
- (void)drawRect:(CGRect)rect
{
    ...
    if([name length])
    {
        ...
        [name drawInRect:CGRectMake(9, 4, 200, 20)
                withFont:[UIFont systemFontOfSize:14]
           lineBreakMode:UILineBreakModeTailTruncation];
    }
    
    NSString* desc = [_item objectForKey:@"desc"];
    if([desc length])
    {
        [[UIColor grayColor] set];
        
        [desc drawInRect:CGRectMake(9, 26, 300,CGFLOAT_MAX)
